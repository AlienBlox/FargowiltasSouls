...
// Type: FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.Desert.AngryTumbler
...
namespace FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.Desert
{
  ...
  {
    public override NPCMatcher CreateMatcher() => new NPCMatcher().MatchType(546);
