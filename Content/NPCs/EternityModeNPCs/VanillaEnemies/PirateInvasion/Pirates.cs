...
// Type: FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.PirateInvasion.Pirates
...
namespace FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.PirateInvasion
{
  public class Pirates : EModeNPCBehaviour
  {
    ...
    {
      return new NPCMatcher().MatchTypeRange(216, 213, 215, 214, 492, 212, 662);
    }
