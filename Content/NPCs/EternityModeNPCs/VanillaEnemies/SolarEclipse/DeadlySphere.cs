...
// Type: FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.SolarEclipse.DeadlySphere
...
namespace FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.SolarEclipse
{
  ...
  {
    public override NPCMatcher CreateMatcher() => new NPCMatcher().MatchType(467);
