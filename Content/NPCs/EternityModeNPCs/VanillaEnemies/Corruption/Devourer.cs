...
// Type: FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.Corruption.Devourer
...
namespace FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.Corruption
{
  ...
  {
    public override NPCMatcher CreateMatcher() => new NPCMatcher().MatchType(7);
