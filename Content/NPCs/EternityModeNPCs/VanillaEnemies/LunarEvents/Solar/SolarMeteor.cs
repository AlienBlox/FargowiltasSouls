...
// Type: FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.LunarEvents.Solar.SolarMeteor
...
namespace FargowiltasSouls.Content.NPCs.EternityModeNPCs.VanillaEnemies.LunarEvents.Solar
{
  public class SolarMeteor : ModProjectile
  {
    ...
    {
      get => "FargowiltasSouls/Content/Bosses/Champions/Cosmos/CosmosMeteor";
    }
    ...
    {
      ((Entity) this.Projectile).velocity = Vector2.op_Addition(Vector2.op_Multiply(Vector2.UnitX, this.Projectile.ai[1]), Vector2.op_Multiply(Vector2.UnitY, this.Projectile.ai[2]));
      this.Projectile.rotation += 0.209439516f;
