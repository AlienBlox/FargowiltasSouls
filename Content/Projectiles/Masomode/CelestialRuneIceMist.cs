...
// Type: FargowiltasSouls.Content.Projectiles.Masomode.CelestialRuneIceMist
      ...
      if (this.Projectile.timeLeft % 60 == 0)
      {
        ...
        for (int index = 0; index < 6; ++index)
        {
          ...
          if (this.Projectile.owner == Main.myPlayer)
            Projectile.NewProjectile(Entity.InheritSource((Entity) this.Projectile), ((Entity) this.Projectile).Center, vector2, ModContent.ProjectileType<CelestialRuneIceSpike>(), this.Projectile.damage, this.Projectile.knockBack, this.Projectile.owner, ((Entity) this.Projectile).velocity.X, ((Entity) this.Projectile).velocity.Y, 0.0f);
        }
      }
