...
// Type: FargowiltasSouls.Content.Projectiles.Masomode.MoonLordFireball
  ...
  public class MoonLordFireball : ModProjectile
  {
    ...
    public virtual void OnKill(int timeLeft)
    {
      ...
      if (!FargoSoulsUtil.HostCheck)
        return;
      Projectile.NewProjectile(((Entity) this.Projectile).GetSource_FromThis((string) null), ((Entity) this.Projectile).Center, Vector2.op_Multiply(6f, Vector2.Normalize(((Entity) this.Projectile).velocity)), 467, this.Projectile.damage, 0.0f, Main.myPlayer, 0.0f, 0.0f, 0.0f);
    }
