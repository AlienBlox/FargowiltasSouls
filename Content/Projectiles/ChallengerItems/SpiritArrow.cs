...
// Type: FargowiltasSouls.Content.Projectiles.ChallengerItems.SpiritArrow
...
namespace FargowiltasSouls.Content.Projectiles.ChallengerItems
{
  public class SpiritArrow : ModProjectile
  {
    ...
    public virtual void AI()
    {
      ...
      if ((double) this.Projectile.ai[1] >= 2.0 * (40.0 / (double) ((Vector2) ref ((Entity) this.Projectile).velocity).Length()))
      {
        if (FargoSoulsUtil.HostCheck)
        {
          int num = this.Projectile.damage / 2;
          Projectile.NewProjectile(((Entity) this.Projectile).GetSource_FromThis((string) null), ((Entity) this.Projectile).Center, Vector2.Zero, ModContent.ProjectileType<SpiritArrowFlame>(), num, this.Projectile.knockBack, Main.myPlayer, 0.0f, 0.0f, 0.0f);
        }
