...
// Type: FargowiltasSouls.Content.Projectiles.LightningArc
  ...
  public class LightningArc : ModProjectile
  {
    ...
    public virtual string Texture
    {
      get
      {
        ...
        interpolatedStringHandler.AppendFormatted<short>((short) 466);
    ...
    public virtual void AI()
    {
      ...
      if (!this.playedsound)
      {
        ...
        this.startSpeed = ((Vector2) ref ((Entity) this.Projectile).velocity).Length();
      }
      if (Vector2.op_Equality(((Entity) this.Projectile).velocity, Vector2.Zero))
      {
        ...
        if (!Utils.NextBool(Main.rand, this.Projectile.extraUpdates))
          return;
...
label_35:
        ...
        {
          ((Entity) this.Projectile).velocity = Vector2.op_Multiply(Utils.RotatedByRandom(Utils.RotatedBy(Vector2.UnitX, (double) this.Projectile.ai[0], new Vector2()), Math.PI / 4.0), this.startSpeed);
