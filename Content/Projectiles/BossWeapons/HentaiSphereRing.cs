...
// Type: FargowiltasSouls.Content.Projectiles.BossWeapons.HentaiSphereRing
...
namespace FargowiltasSouls.Content.Projectiles.BossWeapons
{
  public class HentaiSphereRing : MutantSphereRing
  {
    ...
    public override void AI()
    {
      ...
      if (this.Projectile.owner != Main.myPlayer || Main.player[this.Projectile.owner].ownedProjectileCounts[ModContent.ProjectileType<HentaiSpearWand>()] >= 1)
        return;
