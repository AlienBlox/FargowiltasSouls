...
// Type: FargowiltasSouls.Content.Projectiles.BossWeapons.HellGuardian
...
namespace FargowiltasSouls.Content.Projectiles.BossWeapons
{
  public class HellGuardian : ModProjectile
  {
    ...
    public virtual void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
      ...
      target.AddBuff(ModContent.BuffType<HellFireMarkedBuff>(), 600, false);
    }
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      {
        Color color = Color.op_Multiply(Color.op_Multiply(Color.Purple, 0.5f), (float) (ProjectileID.Sets.TrailCacheLength[this.Projectile.type] - index) / (float) ProjectileID.Sets.TrailCacheLength[this.Projectile.type]);
