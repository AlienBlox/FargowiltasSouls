...
// Type: FargowiltasSouls.Content.Projectiles.BossWeapons.HentaiSpearDeathray
    ...
    public override void AI()
    {
      ...
      else
      {
        ...
        for (int index = 0; index < numArray.Length; ++index)
          numArray[index] = this.Projectile.localAI[0] * this.Projectile.ai[1];
        float num2 = 0.0f;
        for (int index = 0; index < numArray.Length; ++index)
          num2 += numArray[index];
