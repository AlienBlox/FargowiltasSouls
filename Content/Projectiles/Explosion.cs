...
// Type: FargowiltasSouls.Content.Projectiles.Explosion
...
namespace FargowiltasSouls.Content.Projectiles
{
  public class Explosion : ModProjectile
  {
    ...
    public virtual void OnKill(int timeLeft)
    {
      ...
      ((Entity) this.Projectile).position.X = ((Entity) this.Projectile).position.X + (float) ((Entity) this.Projectile).width / 2f;
      ((Entity) this.Projectile).position.Y = ((Entity) this.Projectile).position.Y + (float) ((Entity) this.Projectile).height / 2f;
      ((Entity) this.Projectile).position.X = ((Entity) this.Projectile).position.X - (float) ((Entity) this.Projectile).width / 2f;
      ((Entity) this.Projectile).position.Y = ((Entity) this.Projectile).position.Y - (float) ((Entity) this.Projectile).height / 2f;
