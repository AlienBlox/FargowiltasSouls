...
// Type: FargowiltasSouls.Content.Projectiles.Deathrays.DeviDeathray
...
namespace FargowiltasSouls.Content.Projectiles.Deathrays
{
  public class DeviDeathray : BaseDeathray, IPixelatedPrimitiveRenderer
  {
    ...
    public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      PrimitiveRenderer.RenderTrail((IEnumerable<Vector2>) vector2Array, new PrimitiveSettings(new PrimitiveSettings.VertexWidthFunction((object) this, __methodptr(WidthFunction)), DeviDeathray.\u003C\u003EO.\u003C0\u003E__ColorFunction ?? (DeviDeathray.\u003C\u003EO.\u003C0\u003E__ColorFunction = new PrimitiveSettings.VertexColorFunction((object) null, __methodptr(ColorFunction))), (PrimitiveSettings.VertexOffsetFunction) null, true, true, shader, new int?(), new int?(), false, new (Vector2, Vector2)?()), new int?(10));
    }
  }
}
