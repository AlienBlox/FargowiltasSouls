...
// Type: FargowiltasSouls.Content.Projectiles.Minions.SkeletronArmL
...
namespace FargowiltasSouls.Content.Projectiles.Minions
{
  public class SkeletronArmL : ModProjectile
  {
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      Main.EntitySpriteDraw(texture2D, Vector2.op_Addition(Vector2.op_Subtraction(((Entity) this.Projectile).Center, Main.screenPosition), new Vector2(0.0f, this.Projectile.gfxOffY)), new Rectangle?(rectangle), this.Projectile.GetAlpha(lightColor), this.Projectile.rotation, vector2, this.Projectile.scale, (SpriteEffects) 1, 0.0f);
      return false;
    }
  }
}
