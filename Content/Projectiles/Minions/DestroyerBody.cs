...
// Type: FargowiltasSouls.Content.Projectiles.Minions.DestroyerBody
...
namespace FargowiltasSouls.Content.Projectiles.Minions
{
  public class DestroyerBody : ModProjectile
  {
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      Texture2D texture2D2 = ModContent.Request<Texture2D>("FargowiltasSouls/Content/Projectiles/Minions/DestroyerBody_glow", (AssetRequestMode) 1).Value;
    ...
    public virtual void AI()
    {
      ...
      int projectileByIdentity = FargoSoulsUtil.GetProjectileByIdentity(this.Projectile.owner, (int) this.Projectile.ai[0], new int[2]
      {
        ...
        ModContent.ProjectileType<DestroyerHead>()
      });
      if (projectileByIdentity >= 0 && ((Entity) Main.projectile[projectileByIdentity]).active)
      {
        ...
        if (Main.projectile[projectileByIdentity].type != ModContent.ProjectileType<DestroyerHead>())
      ...
      if (--this.attackTimer <= 0)
        this.attackTimer = Main.rand.Next(150) + 150;
      ...
      if (index1 == -1)
        return;
      Projectile.NewProjectile(((Entity) this.Projectile).GetSource_FromThis((string) null), ((Entity) this.Projectile).Center, Vector2.op_Multiply(10f, Luminance.Common.Utilities.Utilities.SafeDirectionTo((Entity) this.Projectile, ((Entity) Main.npc[index1]).Center)), 389, this.Projectile.damage, this.Projectile.knockBack, this.Projectile.owner, 0.0f, 0.0f, 0.0f);
    ...
    public virtual void OnKill(int timeLeft)
    {
      ...
      if (Main.dedServ)
        return;
      int index = Gore.NewGore(((Entity) this.Projectile).GetSource_FromThis((string) null), ((Entity) this.Projectile).Center, Vector2.op_Division(((Entity) this.Projectile).velocity, 2f), ModContent.Find<ModGore>("FargowiltasSouls/DestroyerBodyGore").Type, this.Projectile.scale);
