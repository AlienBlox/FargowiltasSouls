...
// Type: FargowiltasSouls.Content.Projectiles.Minions.DestroyerTail2
...
namespace FargowiltasSouls.Content.Projectiles.Minions
{
  ...
  {
    public virtual string Texture => "Terraria/Images/NPC_136";
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      Texture2D texture2D2 = ModContent.Request<Texture2D>("FargowiltasSouls/Content/Projectiles/Minions/DestroyerTail2_glow", (AssetRequestMode) 1).Value;
    ...
    public virtual void AI()
    {
      ...
      {
        ModContent.ProjectileType<DestroyerBody2>()
      });
