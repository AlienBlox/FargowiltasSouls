...
// Type: FargowiltasSouls.Content.Projectiles.Minions.LunarCultistFireball
  ...
  public class LunarCultistFireball : ModProjectile
  {
    ...
    public virtual void AI()
    {
      ...
      if (npc != null)
      {
        ...
        ((Entity) this.Projectile).velocity = Utils.RotatedBy(new Vector2(((Vector2) ref ((Entity) this.Projectile).velocity).Length(), 0.0f), (double) Utils.AngleLerp(rotation1, rotation2, (float) (0.016000000759959221 + 0.31999999284744263 * (double) Math.Min(1f, this.Projectile.ai[0] / 180f))), new Vector2());
