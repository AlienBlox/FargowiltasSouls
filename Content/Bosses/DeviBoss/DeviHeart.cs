...
// Type: FargowiltasSouls.Content.Bosses.DeviBoss.DeviHeart
...
namespace FargowiltasSouls.Content.Bosses.DeviBoss
{
  public class DeviHeart : ModProjectile
  {
    ...
    public virtual bool CanHitPlayer(Player target) => !target.stoned;
    ...
    public virtual void OnKill(int timeLeft)
    {
      ...
      {
        int index2 = Dust.NewDust(((Entity) this.Projectile).position, ((Entity) this.Projectile).width, ((Entity) this.Projectile).height, 86, 0.0f, 0.0f, 0, new Color(), 0.9f);
