...
// Type: FargowiltasSouls.Content.Bosses.Champions.Life.LifeDeathraySmall
    ...
    public virtual void AI()
    {
      ...
      else
      {
        ...
        else
        {
          ...
          float num2 = Main.npc[(int) this.Projectile.ai[1]].ai[3] - 1.57079637f + this.Projectile.ai[0];
