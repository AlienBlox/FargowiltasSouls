...
// Type: FargowiltasSouls.Content.Bosses.Champions.Life.LifeDeathray2
...
namespace FargowiltasSouls.Content.Bosses.Champions.Life
{
  public class LifeDeathray2 : BaseDeathray
  {
    ...
    public virtual void AI()
    {
      ...
      NPC npc = FargoSoulsUtil.NPCExists(this.Projectile.ai[1], ModContent.NPCType<LifeChampion>());
      if (npc == null)
      {
