...
// Type: FargowiltasSouls.Content.Bosses.Champions.Timber.TimberSnowball2
...
namespace FargowiltasSouls.Content.Bosses.Champions.Timber
{
  public class TimberSnowball2 : ModProjectile
  {
    ...
    public virtual void AI()
    {
      ...
      this.Projectile.tileCollide = (double) ((Entity) this.Projectile).position.Y > (double) ((Entity) Main.player[(int) this.Projectile.ai[0]]).position.Y + (double) ((Entity) Main.player[(int) this.Projectile.ai[0]]).height;
      Projectile projectile = this.Projectile;
      ((Entity) projectile).position = Vector2.op_Addition(((Entity) projectile).position, ((Entity) Main.npc[(int) this.Projectile.ai[1]]).velocity);
    }
