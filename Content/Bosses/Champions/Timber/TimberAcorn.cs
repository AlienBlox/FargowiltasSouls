...
// Type: FargowiltasSouls.Content.Bosses.Champions.Timber.TimberAcorn
...
namespace FargowiltasSouls.Content.Bosses.Champions.Timber
{
  public class TimberAcorn : ModProjectile
  {
    ...
    public virtual void AI()
    {
      ...
      this.Projectile.rotation = Utils.ToRotation(((Entity) this.Projectile).velocity) + 3.926991f;
    }
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      {
        Color color = Color.op_Multiply(Color.op_Multiply(Color.op_Multiply(Color.op_Multiply(Color.White, this.Projectile.Opacity), 0.5f), 0.5f), (float) (ProjectileID.Sets.TrailCacheLength[this.Projectile.type] - index) / (float) ProjectileID.Sets.TrailCacheLength[this.Projectile.type]);
