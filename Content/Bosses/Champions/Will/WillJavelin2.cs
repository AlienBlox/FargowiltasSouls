...
// Type: FargowiltasSouls.Content.Bosses.Champions.Will.WillJavelin2
...
namespace FargowiltasSouls.Content.Bosses.Champions.Will
{
  public class WillJavelin2 : ModProjectile
  {
    ...
    public virtual bool? CanDamage() => new bool?((double) this.Projectile.localAI[0] > 180.0);

    public virtual void AI()
    {
      if ((double) this.Projectile.localAI[1] == 0.0)
        this.Projectile.localAI[1] = (double) ((Entity) this.Projectile).Center.Y > (double) this.Projectile.ai[1] ? 1f : -1f;
      if ((double) ++this.Projectile.localAI[0] < 180.0)
      {
        Vector2 vector2 = Vector2.op_Division(Vector2.op_Subtraction(new Vector2(this.Projectile.ai[0], this.Projectile.ai[1]), ((Entity) this.Projectile).Center), 8f);
      ...
      else if ((double) this.Projectile.localAI[0] == 180.0)
      {
        ...
        ((Entity) this.Projectile).velocity.Y = 40f * this.Projectile.localAI[1];
      }
