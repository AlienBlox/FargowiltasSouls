...
// Type: FargowiltasSouls.Content.Bosses.Champions.Will.WillDeathray
...
namespace FargowiltasSouls.Content.Bosses.Champions.Will
{
  public class WillDeathray : BaseDeathray
  {
    ...
    public virtual void AI()
    {
      ...
      else
      {
        ...
        else
        {
          ...
          float num2 = Utils.ToRotation(((Entity) this.Projectile).velocity) - 1.57079637f + this.Projectile.ai[0];
    ...
    public override bool PreDraw(ref Color lightColor)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      PrimitiveRenderer.RenderTrail((IEnumerable<Vector2>) vector2Array, new PrimitiveSettings(new PrimitiveSettings.VertexWidthFunction((object) this, __methodptr(WidthFunction)), WillDeathray.\u003C\u003EO.\u003C0\u003E__ColorFunction ?? (WillDeathray.\u003C\u003EO.\u003C0\u003E__ColorFunction = new PrimitiveSettings.VertexColorFunction((object) null, __methodptr(ColorFunction))), (PrimitiveSettings.VertexOffsetFunction) null, true, false, shader, new int?(), new int?(), false, new (Vector2, Vector2)?()), new int?(30));
      return false;
    }
  }
}
