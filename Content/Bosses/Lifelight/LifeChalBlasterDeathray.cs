...
// Type: FargowiltasSouls.Content.Bosses.Lifelight.LifeChalBlasterDeathray
...
namespace FargowiltasSouls.Content.Bosses.Lifelight
{
  public class LifeChalBlasterDeathray : BaseDeathray
  {
    ...
    public LifeChalBlasterDeathray()
      : base(40f)
    {
    }
    ...
    public virtual void AI()
    {
      ...
      {
        this.Projectile.scale = (float) Math.Sin((double) this.Projectile.localAI[0] * 3.1415927410125732 / (double) this.maxTime) * 2f * num1;
