...
// Type: FargowiltasSouls.Content.Bosses.MutantBoss.MutantDeathrayAim
...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
  public class MutantDeathrayAim : BaseDeathray, IPixelatedPrimitiveRenderer
  {
    ...
    {
      this.maxTime = this.Projectile.ai[0];
      ...
      if (npc != null && !npc.dontTakeDamage && !WorldSavingSystem.MasochistModeReal)
      {
        ...
        else
        {
          ...
          ((Entity) this.Projectile).velocity = Utils.ToRotationVector2(Utils.AngleLerp(Utils.ToRotation(((Entity) this.Projectile).velocity), Utils.ToRotation(Luminance.Common.Utilities.Utilities.SafeDirectionTo((Entity) npc, Vector2.op_Addition(((Entity) Main.player[npc.target]).Center, Vector2.op_Multiply(((Entity) Main.player[npc.target]).velocity, 30f)))), 0.2f));
    ...
    public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      PrimitiveRenderer.RenderTrail((IEnumerable<Vector2>) vector2Array, new PrimitiveSettings(new PrimitiveSettings.VertexWidthFunction((object) this, __methodptr(WidthFunction)), MutantDeathrayAim.\u003C\u003EO.\u003C0\u003E__ColorFunction ?? (MutantDeathrayAim.\u003C\u003EO.\u003C0\u003E__ColorFunction = new PrimitiveSettings.VertexColorFunction((object) null, __methodptr(ColorFunction))), (PrimitiveSettings.VertexOffsetFunction) null, true, true, shader, new int?(), new int?(), false, new (Vector2, Vector2)?()), new int?(20));
    }
  }
}
