...
// Type: FargowiltasSouls.Content.Bosses.MutantBoss.MutantDestroyerBody
...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
  public class MutantDestroyerBody : ModProjectile
  {
    public virtual string Texture
    {
      get
      {
        return !FargoSoulsUtil.AprilFools ? "FargowiltasSouls/Assets/ExtraTextures/Resprites/NPC_135" : "FargowiltasSouls/Content/Bosses/MutantBoss/MutantDestroyerBody_April";
      }
    }
    ...
    {
      Texture2D texture2D = (double) this.Projectile.ai[2] == 0.0 ? TextureAssets.Projectile[this.Projectile.type].Value : ModContent.Request<Texture2D>("FargowiltasSouls/Assets/ExtraTextures/Resprites/NPC_14", (AssetRequestMode) 1).Value;
    ...
    public virtual void AI()
    {
      ...
      int projectileByIdentity = FargoSoulsUtil.GetProjectileByIdentity(this.Projectile.owner, (int) this.Projectile.ai[0], new int[2]
      {
        ...
        ModContent.ProjectileType<MutantDestroyerHead>()
      });
      if (projectileByIdentity >= 0 && ((Entity) Main.projectile[projectileByIdentity]).active)
      {
        ...
        if (Main.projectile[projectileByIdentity].type != ModContent.ProjectileType<MutantDestroyerHead>())
    ...
    public virtual void OnKill(int timeLeft)
    {
      ...
      if (Main.dedServ)
        return;
      int index = Gore.NewGore(((Entity) this.Projectile).GetSource_FromThis((string) null), ((Entity) this.Projectile).Center, Vector2.op_Division(((Entity) this.Projectile).velocity, 2f), (double) this.Projectile.ai[2] == 0.0 ? 156 : 25, this.Projectile.scale);
