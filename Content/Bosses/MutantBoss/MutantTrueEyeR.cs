...
// Type: FargowiltasSouls.Content.Bosses.MutantBoss.MutantTrueEyeR
...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
  public class MutantTrueEyeR : ModProjectile
  {
    ...
    public virtual void AI()
    {
      ...
      {
        case 0:
          Vector2 vector2_1 = Vector2.op_Addition(Vector2.op_Subtraction(((Entity) player).Center, ((Entity) this.Projectile).Center), new Vector2(300f * this.Projectile.localAI[1], -300f));
        ...
        case 1:
          if ((double) this.Projectile.localAI[0] == 1.0)
          {
            ...
            {
              Vector2 vector2_2 = Vector2.op_Addition(Vector2.op_Subtraction(((Entity) this.Projectile).Center, Vector2.op_Multiply(Vector2.UnitY, 6f)), Utils.RotatedBy(new Vector2(100f, 0.0f), 1.0471975803375244 * (double) index, new Vector2()));
              if (FargoSoulsUtil.HostCheck)
                Projectile.NewProjectile(Entity.InheritSource((Entity) this.Projectile), vector2_2, Vector2.Zero, ModContent.ProjectileType<MutantTrueEyeSphere>(), this.Projectile.damage, 0.0f, this.Projectile.owner, (float) this.Projectile.identity, (float) index, 0.0f);
            }
          }
        ...
        case 2:
          if ((double) this.Projectile.localAI[0] == 1.0)
          {
            ...
            ((Entity) this.Projectile).velocity = Vector2.op_Subtraction(((Entity) player).Center, ((Entity) this.Projectile).Center);
