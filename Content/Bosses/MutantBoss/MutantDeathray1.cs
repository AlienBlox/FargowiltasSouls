...
// Type: FargowiltasSouls.Content.Bosses.MutantBoss.MutantDeathray1
...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
  public class MutantDeathray1 : MutantSpecialDeathray, IPixelatedPrimitiveRenderer
  {
    ...
    public virtual bool? CanDamage() => new bool?((double) this.Projectile.scale >= 1.0);
    ...
    public override void AI()
    {
      ...
      {
        this.Projectile.scale = (float) Math.Sin((double) this.Projectile.localAI[0] * 3.1415927410125732 / (double) this.maxTime) * 4f * num1;
    ...
    public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      PrimitiveRenderer.RenderTrail((IEnumerable<Vector2>) vector2Array, new PrimitiveSettings(new PrimitiveSettings.VertexWidthFunction((object) this, __methodptr(WidthFunction)), MutantDeathray1.\u003C\u003EO.\u003C0\u003E__ColorFunction ?? (MutantDeathray1.\u003C\u003EO.\u003C0\u003E__ColorFunction = new PrimitiveSettings.VertexColorFunction((object) null, __methodptr(ColorFunction))), (PrimitiveSettings.VertexOffsetFunction) null, true, true, shader, new int?(), new int?(), false, new (Vector2, Vector2)?()), new int?(25));
    }
  }
}
