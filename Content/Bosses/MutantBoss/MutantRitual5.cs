...
// Type: FargowiltasSouls.Content.Bosses.MutantBoss.MutantRitual5
...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
  public class MutantRitual5 : ModProjectile
  {
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      {
        Vector2 vector2_3 = Utils.RotatedBy(Utils.RotatedBy(new Vector2((float) (350.0 * (double) this.Projectile.scale / 2.0), 0.0f), (double) this.Projectile.ai[0], new Vector2()), 0.89759790897369385 * (double) index1, new Vector2());
        for (int index2 = 0; index2 < 4; ++index2)
        {
          Color color2 = Color.op_Multiply(alpha, (float) (4 - index2) / 4f);
          Vector2 vector2_4 = Vector2.op_Addition(((Entity) this.Projectile).Center, Utils.RotatedBy(vector2_3, 0.055115662515163422 * (double) -index2, new Vector2()));
