...
// Type: FargowiltasSouls.Content.Bosses.MutantBoss.MutantRitual4
...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
  public class MutantRitual4 : ModProjectile
  {
    ...
    private const float rotationPerTick = 0.02094395f;
    private const float threshold = 2100f;
    ...
    public virtual void AI()
    {
      ...
      this.Projectile.ai[0] -= (float) Math.PI / 150f;
    ...
    public virtual bool PreDraw(ref Color lightColor)
    {
      ...
      {
        Vector2 vector2_3 = Utils.RotatedBy(Utils.RotatedBy(new Vector2((float) (2100.0 * (double) this.Projectile.scale / 2.0), 0.0f), (double) this.Projectile.ai[0], new Vector2()), 0.29919931292533875 * (double) index1, new Vector2());
        for (int index2 = 0; index2 < 4; ++index2)
        {
          Color color2 = Color.op_Multiply(alpha, (float) (4 - index2) / 4f);
          Vector2 vector2_4 = Vector2.op_Addition(((Entity) this.Projectile).Center, Utils.RotatedBy(vector2_3, Math.PI / 150.0 * (double) index2, new Vector2()));
