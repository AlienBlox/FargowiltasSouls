...
// Type: FargowiltasSouls.Content.Items.Pets.MostlyOrdinaryRock
...
namespace FargowiltasSouls.Content.Items.Pets
{
  public class MostlyOrdinaryRock : SoulsItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<SeekerOfTreasures>();
      this.Item.buffType = ModContent.BuffType<SeekerOfTreasuresBuff>();
    }
