...
// Type: FargowiltasSouls.Content.Items.Pets.ChibiHat
...
namespace FargowiltasSouls.Content.Items.Pets
{
  public class ChibiHat : SoulsItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<ChibiDevi>();
      this.Item.buffType = ModContent.BuffType<ChibiDeviBuff>();
    }
