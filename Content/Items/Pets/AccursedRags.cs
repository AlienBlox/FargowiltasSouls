...
// Type: FargowiltasSouls.Content.Items.Pets.AccursedRags
...
namespace FargowiltasSouls.Content.Items.Pets
{
  public class AccursedRags : SoulsItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<AccursedSarcophagus>();
      this.Item.buffType = ModContent.BuffType<AccursedSarcophagusBuff>();
    }
