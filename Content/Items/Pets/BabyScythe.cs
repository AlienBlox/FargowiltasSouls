...
// Type: FargowiltasSouls.Content.Items.Pets.BabyScythe
...
namespace FargowiltasSouls.Content.Items.Pets
{
  public class BabyScythe : SoulsItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<BabyAbom>();
      this.Item.buffType = ModContent.BuffType<BabyAbomBuff>();
    }
