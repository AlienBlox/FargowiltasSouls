...
// Type: FargowiltasSouls.Content.Items.Pets.PortableFogMachine
...
namespace FargowiltasSouls.Content.Items.Pets
{
  public class PortableFogMachine : SoulsItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<BabySilhouette>();
      this.Item.buffType = ModContent.BuffType<BabySilhouetteBuff>();
    }
