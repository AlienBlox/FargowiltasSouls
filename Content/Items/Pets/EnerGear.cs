...
// Type: FargowiltasSouls.Content.Items.Pets.EnerGear
...
namespace FargowiltasSouls.Content.Items.Pets
{
  public class EnerGear : SoulsItem
  {
    ...
    {
      Main.RegisterItemAnimation(this.Item.type, (DrawAnimation) new DrawAnimationVertical(5, 11, false));
    ...
    {
      this.Item.CloneDefaults(4808);
      this.Item.shoot = ModContent.ProjectileType<BiteSizeBaron>();
      this.Item.buffType = ModContent.BuffType<BiteSizeBaronBuff>();
    }
