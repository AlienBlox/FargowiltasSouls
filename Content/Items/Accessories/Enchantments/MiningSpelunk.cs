...
// Type: FargowiltasSouls.Content.Items.Accessories.Enchantments.MiningSpelunk
...
namespace FargowiltasSouls.Content.Items.Accessories.Enchantments
{
  public class MiningSpelunk : AccessoryEffect
  {
    ...
    public override void PostUpdateEquips(Player player) => player.findTreasure = true;
  }
}
