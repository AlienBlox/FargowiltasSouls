...
// Type: FargowiltasSouls.Content.Items.Accessories.Masomode.FrigidGemstone
...
namespace FargowiltasSouls.Content.Items.Accessories.Masomode
{
  public class FrigidGemstone : SoulsItem
  {
    ...
    public virtual void UpdateInventory(Player player) => this.Effects(player);
    ...
    {
      player.ReplaceItem(this.Item, ModContent.ItemType<FrigidGemstoneInactive>());
    }
  }
}
