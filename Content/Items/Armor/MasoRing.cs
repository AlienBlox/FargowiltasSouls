...
// Type: FargowiltasSouls.Content.Items.Armor.MasoRing
  ...
  public class MasoRing : AccessoryEffect
  {
    ...
    public override void PostUpdateEquips(Player player)
    {
      ...
      if (player.ownedProjectileCounts[ModContent.ProjectileType<PhantasmalRing>()] >= 1)
        return;
      FargoSoulsUtil.NewSummonProjectile(((Entity) player).GetSource_Misc(""), ((Entity) player).Center, Vector2.Zero, ModContent.ProjectileType<PhantasmalRing>(), 1700, 0.0f, ((Entity) player).whoAmI);
    }
  }
}
