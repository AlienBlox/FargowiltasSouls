...
// Type: FargowiltasSouls.Content.Items.Placables.MusicBoxes.RePrologueMusicBox
  ...
  public class RePrologueMusicBox : ModItem
  {
    public virtual void SetStaticDefaults()
    {
      ...
      if (!Terraria.ModLoader.ModLoader.TryGetMod("FargowiltasMusic", ref mod))
        return;
      MusicLoader.AddMusicBox(((ModType) this).Mod, MusicLoader.GetMusicSlot(mod, "Assets/Music/rePrologue"), ModContent.ItemType<RePrologueMusicBox>(), ModContent.TileType<RePrologueMusicBoxSheet>(), 0);
    }
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.createTile = ModContent.TileType<RePrologueMusicBoxSheet>();
