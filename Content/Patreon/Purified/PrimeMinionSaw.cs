...
// Type: FargowiltasSouls.Content.Patreon.Purified.PrimeMinionSaw
    ...
    public virtual void AI()
    {
      ...
      else
      {
        ...
        if (minionAttackTargetNpc != null && minionAttackTargetNpc.CanBeChasedBy((object) this, false))
        {
          ...
          if ((double) ((Vector2) ref vector2_1).Length() < 1000.0 && (double) ((Vector2) ref vector2_2).Length() < 200.0)
          {
        ...
        else if (!flag)
        {
          ...
          for (int index4 = 0; index4 < 200; ++index4)
          {
            if (Main.npc[index4].CanBeChasedBy((object) this, false))
            {
              ...
              if ((double) ((Vector2) ref vector2_3).Length() < (double) num && (double) ((Vector2) ref vector2_4).Length() < 200.0)
              {
